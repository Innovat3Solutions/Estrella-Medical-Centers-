...
const insurancePlans = [
  ...
  { name: 'Insurance Partner', logo: '/assets/images/insurance/36.png' },
  { name: 'Insurance Partner', logo: '/assets/images/insurance/37.png' },
  { name: 'Insurance Partner', logo: '/assets/images/insurance/38.png' },
  { name: 'Insurance Partner', logo: '/assets/images/insurance/39.png' },
  { name: 'Insurance Partner', logo: '/assets/images/insurance/40.png' },
  { name: 'Insurance Partner', logo: '/assets/images/insurance/41.png' },
];
